    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className={`h-16 flex items-center border-b border-gray-800 ${isCollapsed ? 'justify-center px-2' : 'px-4'}`}>
            {!isCollapsed ? (
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                  <span className="text-gray-900 font-bold text-sm">GPS</span>
                </div>
          ...
          <button
            onClick={onToggle}
            className="hidden lg:flex absolute -right-3 top-20 w-6 h-6 bg-gray-900 border border-gray-700 rounded-full items-center justify-center text-gray-400 hover:text-white transition-colors"
          >
            <svg 
