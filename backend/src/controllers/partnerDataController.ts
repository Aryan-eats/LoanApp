...
import { runSoftCheck, type SoftCheckBank, type SoftCheckInput } from '../services/softCheckService.js';
...
/**
 * POST /api/partner/soft-check
 * Runs a declared-data soft eligibility check. This is not a bureau pull and has no credit impact.
 */
